...
class FaceDetector {
     ...
     */
    private fun onMaskDetect(boxRect: Rect, colorBitmap: Bitmap, depthBitmap: Mat) {
     ...
     */
    private fun onDepthDetect(boxRect: Rect, colorBitmap: Bitmap, depthBitmap: Mat) {
        val faceDepthBitmap = depthBitmap.toBitmap(boxRect)
